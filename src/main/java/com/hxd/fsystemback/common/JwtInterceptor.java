...
public class JwtInterceptor implements HandlerInterceptor{
        ...
        public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
                ...
                if(StrUtil.isBlank(token)){
                        ...
                        throw new RuntimeException(new CustomException("请重新登录"));
                }
                String userId;
                User user;
                try {
                        ...
                        throw new RuntimeException(new CustomException(errMsg));
                }
                if (user == null){
                        throw new RuntimeException(new CustomException("用户不存在"));
                }
                try {
